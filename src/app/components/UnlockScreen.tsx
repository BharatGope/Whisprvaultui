  ...
  return (
    <div className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-xl sm:rounded-3xl shadow-2xl p-4 sm:p-8 backdrop-blur-sm bg-opacity-95 h-full flex flex-col justify-center`}>
      <div className="text-center mb-6 sm:mb-8">
        ...
        <h1 className={`${darkMode ? "text-white" : "text-indigo-600"} mb-2 text-xl sm:text-2xl`}>
          WhisprVault
        </h1>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div>
          <h2 className={`${darkMode ? "text-white" : "text-gray-800"} mb-4 sm:mb-6 text-base sm:text-lg`}>
            Enter Password
          </h2>
          ...
          <div className="relative mb-3 sm:mb-4">
            <input
              ...
              } border-2 rounded-lg sm:rounded-xl focus:border-indigo-500 focus:outline-none ${
                darkMode ? "focus:bg-gray-600" : "focus:bg-white"
          ...
          {error && (
            <div className="mb-3 sm:mb-4 text-red-500 text-center text-sm">
              {error}
            </div>
          )}
