        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-white text-base sm:text-lg">{note ? "Edit Note" : "Add Note"}</h1>
            </div>
          </div>
          ...
          {links.length > 0 && (
            <div className="space-y-2">
              {links.map((link, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-2 ${darkMode ? 'bg-gradient-to-br from-blue-900 to-cyan-900 border-blue-800' : 'bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-100'} border-2 rounded-lg sm:rounded-xl p-2.5 sm:p-3`}
                >
                  ...
                  <button
                    ...
                    className={`p-1 ${darkMode ? 'hover:bg-red-900' : 'hover:bg-red-100'} rounded-lg transition-all active:scale-95`}
                  >
          ...
          {attachments.length > 0 && (
            <div className="space-y-2 mt-2">
              {attachments.map((attachment, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-2 ${darkMode ? 'bg-gradient-to-br from-purple-900 to-pink-900 border-purple-800' : 'bg-gradient-to-br from-purple-50 to-pink-50 border-purple-100'} border-2 rounded-lg sm:rounded-xl p-2.5 sm:p-3`}
                >
