          ...
          <div>
            ...
            <div className="space-y-2">
              {note.attachments.map((attachment, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-2 ${darkMode ? 'bg-gradient-to-br from-purple-900 to-pink-900 border-purple-800 hover:from-purple-800 hover:to-pink-800' : 'bg-gradient-to-br from-purple-50 to-pink-50 border-purple-100 hover:from-purple-100 hover:to-pink-100'} border-2 rounded-lg sm:rounded-xl p-2.5 sm:p-3 transition-all group`}
                >
